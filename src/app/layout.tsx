        ...
        <footer className="bg-black/90 text-white py-8 mt-12 border-t border-white/50">
          <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6 mt-4 md:mt-0">
              <a href="mailto:gus.tec.dev@gmail.com" className="flex items-center space-x-2 hover:text-gray-400 transition">
              ...
              <a href="https://www.linkedin.com/in/gustavo-vinicius-596005276/" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 hover:text-gray-400 transition">
